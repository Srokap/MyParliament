            ...
            <tr>
              <td style="background-color: #FFFFFF; border-bottom: 1px solid #CCCCCC; border-left: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC; font-family: tahoma,'lucida grande',verdana,arial,sans-serif; padding: 15px;" valign="top">
	              ...
	              <div style="font-size: 12px;">
		              <div style="margin-bottom: 5px;">Witaj {$username},</div>
		              <div>
		                <p>Aby dokończyć proces odzyskania hasla na portalu OchParliament przejdź na stronę <a href="{$M.SITE_ADDRESS}/odzyskanie_hasla?key={$pass_recover}&tab=pass" style="text-decoration: none; color: #0083B8;">http://sejmometr.pl/odzyskanie_hasla?key={$pass_recover}&tab=pass</a></p>
		              </div>
