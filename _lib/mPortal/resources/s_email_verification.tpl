            ...
            <tr>
              <td style="background-color: #FFFFFF; border-bottom: 1px solid #CCCCCC; border-left: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC; font-family: tahoma,'lucida grande',verdana,arial,sans-serif; padding: 15px;" valign="top">
	              ...
	              <div style="font-size: 12px;">
		              ...
		              <div>
		                <p>Aby dokończyć proces rejestracji na portalu OchParliament przejdź na stronę <a href="{$SITE_ADDRESS}/weryfikacja?key={$email_pass}" style="text-decoration: none; color: #0083B8;">http://sejmometr.pl/weryfikacja?key={$email_pass}</a></p>
		              </div>
