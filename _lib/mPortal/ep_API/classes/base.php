...
*/  
  ...
  @include_once('objects/ep_Wybory_Samorzadowe_Okreg.php');  
  @include_once('objects/ep_Wybory_Samorzadowe_Szczebel.php'); 
  @include_once('objects/ep_Wybory_Samorzadowe_Rady_Kandydat.php');   
  ...
  @include_once('objects/ep_Legislacja_Faza.php'); 
