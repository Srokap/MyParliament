    ...
    function query($q){
      ...
      if( $data===false ) {
        ...
        if( $_SERVER['M']->isAdmin() ) {
	        ...
	        echo '<?xml version="1.0" encoding="utf-8"?><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd"><html><head profile="http://www.w3.org/2005/10/profile"> <meta http-equiv="content-type" content="text/html; charset=UTF-8"></head><body>Wystąpił nieoczekiwany błąd. Przepraszamy.<br/><a href="'.SITE_ADDRESS.'">OchParliament</a></body></html>';
	        die();
        }
