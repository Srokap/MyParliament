<?php /* Smarty version 2.6.19, created on 2013-01-22 15:13:59
         compiled from /Users/bona/Desktop/Work/OchParlament/_lib/mPortal/resources/layout.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/Users/bona/Desktop/Work/OchParlament/_lib/mPortal/resources/layout.tpl', 9, false),array('modifier', 'strip_tags', '/Users/bona/Desktop/Work/OchParlament/_lib/mPortal/resources/layout.tpl', 12, false),array('modifier', 'cat', '/Users/bona/Desktop/Work/OchParlament/_lib/mPortal/resources/layout.tpl', 27, false),array('modifier', 'default', '/Users/bona/Desktop/Work/OchParlament/_lib/mPortal/resources/layout.tpl', 100, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <div id="_LIGHTBOXES">
	    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => ((is_array($_tmp=$this->_tpl_vars['M']['ROOT'])) ? $this->_run_mod_handler('cat', true, $_tmp, "/_layout/login_loading_lb.tpl") : smarty_modifier_cat($_tmp, "/_layout/login_loading_lb.tpl")), 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
      <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => ((is_array($_tmp=$this->_tpl_vars['M']['ROOT'])) ? $this->_run_mod_handler('cat', true, $_tmp, "/_layout/logout_loading_lb.tpl") : smarty_modifier_cat($_tmp, "/_layout/logout_loading_lb.tpl")), 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    </div>
...
<?php echo '\', // App ID
		    channelUrl : \'//sejmometr.pl/channel.html\', // Channel File
...
';
					<?php echo 'var'; ?>
 disqus_url = 'http://sejmometr.pl/<?php echo $this->_tpl_vars['M']['disqus_url']; ?>
';
        <?php endif; ?>
      </script>
    <?php endif; ?>
